    ...
    <div className="bg-slate-50 border-b border-slate-200 py-2 sm:py-3 px-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-3 md:gap-5 relative z-10 text-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 text-slate-500 font-normal italic text-xs sm:text-sm">
            {/* Icona Microfono */}
          ...
          <img 
            ...
            className="h-9 sm:h-12 object-contain opacity-90 hover:opacity-100 cursor-default transition-opacity duration-300" 
          />
        </div>
        ...
        <div className="flex items-center max-w-xl text-center md:text-left">
          <p className="text-xs sm:text-sm text-slate-600 font-normal italic">
            «Un professionista <span className="font-medium text-slate-900 bg-green-100 px-1 py-0.5 rounded not-italic">chiaro e preparato</span>. Grazie per il suo intervento e per aver partecipato all'intervista.»
          </p>
        </div>
