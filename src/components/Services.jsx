    ...
    sections: [
      {
        ...
        body: "Il piano segue le linee guida internazionali con una prima fase di dieta low-FODMAP, a basso contenuto di oligosaccaridi. Si accompagna a un'integrazione mirata alla risoluzione della disbiosi intestinale, che spesso è alla base del colon irritabile. La risoluzione della disbiosi richiede costanza, per questo il Washout ti accompagnerà lungo tutto il percorso. Non è una fase passeggera, ma un protocollo di \"manutenzione\" intestinale che azzera i fastidi e ripristina l'equilibrio della flora batterica.",
        sectionColor: 'emerald'
      },
      {
...
function DietDrawer ({ diet, onClose }) {
  ...
  useEffect(() => {
    // Save scroll position before making body fixed
